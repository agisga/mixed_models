...
describe LMM do
  describe "#initialize" do
    context "with fixed and random intercept and slope" do
      ...
      it "finds the minimal REML deviance correctly" do
        expect(model_fit.dev_optimal).to be_within(1e-2).of(162.90)
      end
  ...
  describe "#from_formula" do
    ...
    context "with categorical fixed and random effects" do
      ...
      it "finds the minimal REML deviance correctly" do
        expect(model_fit.dev_optimal).to be_within(1e-4).of(285.3409)
      end
