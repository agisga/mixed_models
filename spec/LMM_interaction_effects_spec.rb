      ...
      describe "#from_daru" do
        subject(:model_fit) do
          LMM.from_daru(response: :y, fixed_effects: [:intercept, :a, :b, [:a, :b]], 
                        random_effects: [[:no_intercept, [:a, :b]]], grouping: [:gr],
                        data: Daru::DataFrame.from_csv("spec/data/numeric_x_numeric_interaction.csv"))
        end
      ...
      describe "#from_daru" do
        subject(:model_fit) do
          LMM.from_daru(response: :y, fixed_effects: [:intercept, :num, :cat, [:num, :cat]],
                        random_effects: [[:no_intercept, [:num, :cat]]], grouping: [:gr],
                        data: Daru::DataFrame.from_csv("spec/data/numeric_x_categorical_interaction.csv"))
        end
      ...
      describe "#from_daru" do
        subject(:model_fit) do
          LMM.from_daru(response: :y, fixed_effects: [:intercept, :cat, :num, [:cat, :num]],
                        random_effects: [[:no_intercept, [:cat, :num]]], grouping: [:gr],
                        data: Daru::DataFrame.from_csv("spec/data/numeric_x_categorical_interaction.csv"))
        end
        ...
        describe "#from_daru" do
          subject(:model_fit) do
            LMM.from_daru(response: :y, fixed_effects: [:intercept, :f1, :f2, [:f1, :f2]],
                          random_effects: [[:no_intercept, [:f1, :f2]]], grouping: [:gr],
                          data: Daru::DataFrame.from_csv("spec/data/categorical_x_categorical_interaction.csv"))
          end
        ...
        describe "#from_daru" do
          subject(:model_fit) do
            LMM.from_daru(response: :y, fixed_effects: [:intercept, [:f1, :f2]],
                          random_effects: [[:no_intercept, :f1, [:f1, :f2]]], grouping: [:gr],
                          data: Daru::DataFrame.from_csv("spec/data/categorical_x_categorical_interaction.csv"))
          end
        ...
        describe "#from_daru" do
          subject(:model_fit) do
            LMM.from_daru(response: :y, fixed_effects: [:intercept, :f2, [:f1, :f2]],
                          random_effects: [[:intercept]], grouping: [:gr],
                          data: Daru::DataFrame.from_csv("spec/data/categorical_x_categorical_interaction.csv"))
          end
